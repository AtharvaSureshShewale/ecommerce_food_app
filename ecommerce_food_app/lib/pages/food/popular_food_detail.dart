...
class PopularFoodDetail extends StatelessWidget {
  final int pageId;
  final String page;
  const PopularFoodDetail({required this.pageId,required this.page,super.key});
                    ...
                    child: Stack(
                      children: [
                        ...
                        controller.totalItems>=1 && controller.totalItems<=9?
                          ...
                          Container(),
                        Get.find<PopularProductController>().totalItems>=10 && Get.find<PopularProductController>().totalItems<=20?
                          Positioned(
                            right:7.2,
                            top: 5.5,
